...
const HEXES = {
  ...
  accent: "#FDFCF7", "focus-button": "#CC622E", "light-purple": "#D5C5FF",
  "soft-lavender": "#E5DCFF", "lavender-official": "#E5D0FF", "light-green": "#D4E6A8",
  "light-orange": "#FFD7C4", pink: "#F39EBC", teal: "#03C9D3", purple: "#DA83DA",
  "very-light-gray": "#F7F7F7", "light-gray": "#D9D9D9",
  "background-default": "#FDFCF7", "background-soft": "#E5DCFF", "background-title": "#D4E6A8",
  ...
  "status.error": "#DC2626", "status.success": "#D4E6A8", "status.warning": "#FFAF89",
  ...
  "green.300": "#E5F0CB", "green.400": "#DDEBB9", "green.500": "#D4E6A8", "green.600": "#AAB886",
