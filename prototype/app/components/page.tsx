    ...
    <>
      ...
      <section id="buttons" className="ds-section">
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: "var(--spacing-4)" }}>
          <button type="button" className="fe-btn-primary">Book Event &rarr;</button>
          <button type="button" className="fe-btn-secondary">Book Event &rarr;</button>
        </div>
        <div
          style={{
            display: "flex",
        ...
        >
          ...
          <button type="button" className="ds-btn ds-btn--orange">Orange</button>
      ...
      <section id="category-tags" className="ds-section">
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: "var(--spacing-3)" }}>
          ...
          <span className="fe-tag-pill fe-tag-pill--green">Balance and Wellness</span>
          <span className="fe-tag-pill fe-tag-pill--orange">Expression</span>
          <span className="fe-tag-pill fe-tag-pill--lavender">Arts and Crafts</span>
      ...
      <section id="cards" className="ds-section">
        ...
        >
          <div className="ds-card">
            ...
            <p className="ds-card-body">Card body text using tokens. Hover for shadow change.</p>
          </div>
          <div className="ds-card">
            <h3 className="ds-card-title">Another card</h3>
            <p className="ds-card-body">Radius and shadow from design tokens. Consistent spacing.</p>
          </div>
          <div className="ds-card">
            <h3 className="ds-card-title">Third card</h3>
            <p className="ds-card-body">Transitions use --transition-base for hover.</p>
          </div>
        </div>
      </section>
      ...
      <section id="icons" className="ds-section">
        ...
        <div className="ds-icon-demo">
          ...
          <div className="ds-icon-item">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/icons/arrow-right.svg" alt="" width={24} height={24} aria-hidden="true" />
            <span>Arrow right</span>
          </div>
          <div className="ds-icon-item">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/icons/external-link.svg" alt="" width={24} height={24} aria-hidden="true" />
      ...
      <section id="forms" className="ds-section">
        ...
        <div style={{ maxWidth: "20rem", display: "flex", flexDirection: "column", gap: "var(--spacing-6)" }}>
          <div className="fe-input-group">
            <label className="fe-label" htmlFor="ds-input-demo">Label</label>
            <input id="ds-input-demo" type="text" className="fe-input" placeholder="Placeholder text" aria-label="Demo input" />
          </div>
          <div className="fe-input-group">
            <label className="fe-label" htmlFor="ds-input-error">Required field</label>
            <input id="ds-input-error" type="text" className="fe-input fe-input--error" placeholder="Label" aria-label="Error state" aria-invalid="true" />
            <span className="fe-input-error-msg">field is required</span>
          </div>
          <div className="fe-input-group">
            <label className="fe-label" htmlFor="ds-input-disabled">Disabled</label>
            <input id="ds-input-disabled" type="text" className="fe-input" placeholder="Label" disabled aria-label="Disabled" />
          </div>
        </div>
      </section>
      ...
      <section id="dropdown" className="ds-section">
        ...
        <div className="fe-dropdown" style={{ width: "14rem" }}>
          <a href="#about" className="fe-dropdown-item">About us <span aria-hidden="true">&rarr;</span></a>
          <a href="#team" className="fe-dropdown-item">Meet The Team <span aria-hidden="true">&rarr;</span></a>
          <a href="#blog" className="fe-dropdown-item">Blog <span aria-hidden="true">&rarr;</span></a>
        </div>
      </section>
