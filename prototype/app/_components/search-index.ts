...
const pages: PageDef[] = [
  ...
  },
  {
    ...
    description:
      "Icon catalog, line illustrations, accent marks, and graphic shapes.",
    sections: [
      "Category icons",
      "Activity icons",
      "Social icons",
  ...
  },
  {
    ...
    title: "Components",
    description:
      "Buttons, inputs, cards, tags, navigation, icon preview, and overlays.",
    sections: [
      "Actions",
      "Forms & inputs",
      "Tags & labels",
